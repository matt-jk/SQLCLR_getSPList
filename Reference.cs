...
/*
 * This was the source file when I created a webservice proxy.  I thought it would be easier to distribute 
 * by just putting this source file in with the others.  The only other way I could get it to work was to
 * leave this web proxy in a seperate shared-dll project and create a reference for it, and that is more
 * difficult to distribute.  Unless Microsoft changes their SharePoint webservice, you won't need to generate
 * a new proxy, but you of course can if you want to.
 * 
 * The only line I changed was line 116
 * 
 * Matt Kalal
 */
#pragma warning disable 1591

namespace SP2010WS.SharePoint2010WS {
    using System;
    ...
    public partial class Lists : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public Lists() {
            //
            // this line changed to set a default for my purposes in publishing
            // mkalal
            //
            this.Url = "http://dummy.org"; // global::SP2010WS.Properties.Settings.Default.SP2010WS_SharePoint2010WS_Lists;
